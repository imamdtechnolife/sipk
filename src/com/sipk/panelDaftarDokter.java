...
public class panelDaftarDokter extends JPanel {
	...
	public panelDaftarDokter() {
		...
		btnSimpanDokter.setIcon(new ImageIcon(panelDaftarDokter.class.getResource("/com/sipk/Image/Simpan.png")));
		btnSimpanDokter.setBounds(499, 402, 101, 32);
		panelDaftarDokter.add(btnSimpanDokter);
		
		btnBatalDokter = new JButton("Batal");
		btnBatalDokter.setIcon(new ImageIcon(panelDaftarDokter.class.getResource("/com/sipk/Image/Batal.png")));
		btnBatalDokter.setBounds(610, 402, 101, 32);
		panelDaftarDokter.add(btnBatalDokter);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon(panelDaftarDokter.class.getResource("/com/sipk/Image/b-dokter.png")));
		...
		btnUbah.setIcon(new ImageIcon(panelDaftarDokter.class.getResource("/com/sipk/Image/Ubah.png")));
		btnUbah.setBounds(499, 402, 101, 32);
		btnUbah.setVisible(false);
		panelDaftarDokter.add(btnUbah);
		
		btnHapus = new JButton("Hapus");
		btnHapus.setIcon(new ImageIcon(panelDaftarDokter.class.getResource("/com/sipk/Image/Hapus.png")));
		btnHapus.setBounds(610, 402, 101, 32);
		btnHapus.setVisible(false);
		panelDaftarDokter.add(btnHapus);
		
		btnRefresh = new JButton("Refresh");
		btnRefresh.setIcon(new ImageIcon(panelDaftarDokter.class.getResource("/com/sipk/Image/Refresh.png")));
