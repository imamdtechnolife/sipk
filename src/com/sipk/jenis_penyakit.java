...
public class jenis_penyakit extends JFrame {
	...
	public JLabel lblkoma_noDTD = new JLabel("       Koma : ");
	public JLabel lblnoDTDasli = new JLabel("No. DTD (asli)");
	public JLabel txtRekap_noDTD = new JLabel();
	public JLabel komDTD = new JLabel();
	public JRadioButton satu = new JRadioButton("1");
	public JRadioButton dua = new JRadioButton("2");
	public JRadioButton tiga = new JRadioButton("3");
	public JRadioButton empat = new JRadioButton("4");
	public JRadioButton lima = new JRadioButton("5");
	public JRadioButton enam = new JRadioButton("6");
	public JRadioButton tujuh = new JRadioButton("7");
	public JRadioButton delapan = new JRadioButton("8");
	public JRadioButton sembilan = new JRadioButton("9");
	public JRadioButton nol = new JRadioButton("0");
	public JRadioButton kosongDTD = new JRadioButton("(Kosong)");
	public JPanel panel_kosong1 = new JPanel();
	public JPanel panel_daftarTerperinci1 = new JPanel();
	public JPanel panel_daftarTerperinci2 = new JPanel();
	public JPanel panel_macamPenyakit = new JPanel();
	public JComboBox combo_noDTD = new JComboBox();
	public JComboBox combo_noDT1 = new JComboBox();
	public JComboBox combo_noDT2 = new JComboBox();
	public JComboBox combo_hurufDT1 = new JComboBox();
	public JComboBox combo_hurufDT2 = new JComboBox();
	public JTextField txtDT2 = new JTextField(5);
	public JRadioButton DT1_satu = new JRadioButton("1");
	public JRadioButton DT1_dua = new JRadioButton("2");
	public JRadioButton DT1_tiga = new JRadioButton("3");
	public JRadioButton DT1_empat = new JRadioButton("4");
	public JRadioButton DT1_lima = new JRadioButton("5");
	public JRadioButton DT1_enam = new JRadioButton("6");
	public JRadioButton DT1_tujuh = new JRadioButton("7");
	public JRadioButton DT1_delapan = new JRadioButton("8");
	public JRadioButton DT1_sembilan = new JRadioButton("9");
	public JRadioButton DT1_kosong = new JRadioButton("(Kosong)");
	public JRadioButton DT1_nol = new JRadioButton("0");
	public JRadioButton DT2_satu = new JRadioButton("1");
	public JRadioButton DT2_dua = new JRadioButton("2");
	public JRadioButton DT2_tiga = new JRadioButton("3");
	public JRadioButton DT2_empat = new JRadioButton("4");
	public JRadioButton DT2_lima = new JRadioButton("5");
	public JRadioButton DT2_enam = new JRadioButton("6");
	public JRadioButton DT2_tujuh = new JRadioButton("7");
	public JRadioButton DT2_delapan = new JRadioButton("8");
	public JRadioButton DT2_sembilan = new JRadioButton("9");
	public JRadioButton DT2_nol = new JRadioButton("0");
	public JRadioButton DT2_kosong = new JRadioButton("(kosong)");
	public JTextField txtRekapDT = new JTextField(5);
	public JLabel hurufDT1 = new JLabel();
	public JLabel angkaDT1 = new JLabel();
	public JLabel komaDT1 = new JLabel();
	public JLabel lblKodeHurufDT1 = new JLabel("Kode Huruf : ");
	public JLabel lblKodeHurufDT2 = new JLabel("Kode Huruf : ");
	public JLabel lblKodeKomaDT1 = new JLabel("Kode Koma : ");
	public JLabel lblKodeKomaDT2 = new JLabel("Kode Koma : ");
	public JLabel lblKodeAngkaDT1 = new JLabel("      Kode Angka : ");
	public JLabel lblKodeAngkaDT2 = new JLabel("      Kode Angka : ");
	public JTextArea txtAreaMacamPenyakit = new JTextArea(2,150);
	public JScrollPane scrolltxtarea = new JScrollPane(txtAreaMacamPenyakit);
	...
	public JButton btnTotalJP = new JButton("Total");
	public JButton btnReport = new JButton("Cetak");
	public String fieldJP[] = {"No. DTD", "No. Daftar Terperinci (ICD-10)","Macam Penyakit"};
	public DefaultTableModel modelTabelJP = new DefaultTableModel(null,fieldJP);
	...
	public ButtonGroup grupDT1 = new ButtonGroup();
	public ButtonGroup grupDT2 = new ButtonGroup();
	private Connection connect;
	private Statement state;
	private ResultSet result;
	private JLabel rekapDTD = new JLabel();
	public JTextField txtPencarianMP = new JTextField(15);
	public JPanel panelPencarianMP = new JPanel();
	public JPanel panelTombolEkstra = new JPanel();
	public JButton btnSampai = new JButton("Sampai");
	public JButton btnDan = new JButton("Dan");
	public JTextField rekapDT2 = new JTextField("Rekap DT2");
	public JLabel hurufDT2 = new JLabel();
	public JLabel angkaDT2 = new JLabel();
	public JLabel komaDT2 = new JLabel();
	boolean i;
	public JPanel panelRincian = new JPanel();
	public JPanel panelDT22 = new JPanel();
	public JPanel panelGabungDT2 = new JPanel();
	public JComboBox comboSampaiDan = new JComboBox();
	public JLabel rekapDT = new JLabel();
